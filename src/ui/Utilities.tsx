...
export const isAddress = (value: any) => {
  ...
  if (len !== 42 && len !== 66) return false;
  if (len === 66 && value.substr(0, 26) !== '0x000000000000000000000000') return false;
  if (len === 66 && value.substr(0, 56) === '0x000000000000000000000000000000000000000000000000000000') return false;
  return true;
};
